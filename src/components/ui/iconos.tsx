...
export function SettingsIcon(props: React.SVGProps<SVGSVGElement>) {
    return (
      <svg
        ...
        strokeLinejoin="round"
      >
            {/* Simplificado el path para evitar errores */}
...
export function GenericAvatarIcon(props: React.SVGProps<SVGSVGElement>) {
  return (
    <svg
      {...props}
      xmlns="http://www.w3.org/2000/svg"
    ...
    >
      ...
      <path d="M16 20H8a4 4 0 0 1-4-4v-1a4 4 0 0 1 4-4h8a4 4 0 0 1 4 4v1a4 4 0 0 1-4 4z" />
    </svg>
  );
}

export function ChatbotIcon(props: React.SVGProps<SVGSVGElement>) {
  return (
    <svg
      {...props}
      xmlns="http://www.w3.org/2000/svg"
...
export function StudyMaterialIcon(props: React.SVGProps<SVGSVGElement>) {
  return (
    <svg
      {...props}
      xmlns="http://www.w3.org/2000/svg"
